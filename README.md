...
I apply a **security-first approach** to ensure systems, applications, and networks remain resilient against evolving threats.  

---

## What I Do  
- Design and implement **secure enterprise architectures**  
- Conduct **risk assessments**, **vulnerability management**, and **threat mitigation**  
- Enforce **Identity and Access Management (IAM)** best practices  
- Secure cloud and applications with:  
  - Terraform (infrastructure security as code)  
  - Kubernetes security hardening  
  - Snyk & SonarQube (code and dependency security)  
  - Cloud-native security controls (AWS and Azure)  

---

## Cloud & Security Experience  
- **AWS** — IAM, GuardDuty, WAF, Shield, security monitoring  
- **Azure** — identity protection, Sentinel, Defender for Cloud  
- **SIEM & Monitoring** — Wazuh, ELK, Grafana  
- **Compliance & Governance** — ISO 27001, NIST, CIS Benchmarks  

---

## Focus  
Delivering secure, reliable, and compliant systems by:  
